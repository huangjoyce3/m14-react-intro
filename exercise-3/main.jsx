                    ...
                    <tbody>
                        ...
                        {// Enter employee rows here!!!!
                            this.props.data.map(function(item, index){
                              return <EmployeeRow key={'employee-' + 
                                index} name={item.name} title={item.title} salary={item.salary}/>  
                            })
                        }
...
ReactDOM.render(<EmployeeTable data={employeeData}/>, document.querySelector('main'));